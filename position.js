...
var Position = module.exports = function(market, type, client, options) {
    this.market = market
    this.client = client
    this.type = type
...
Position.prototype.get = function(cb) {
    ...
    this.client.orders(function(err, orders) {
        ...
        // Ignore orders for other markets and types
...
Position.prototype.sync = function(desired, cb) {
    ...
    async.waterfall([
        ...
        function(orders, next) {
            ...
            actual = actual.filter(function(order) {
                return order.type == that.type
            })
